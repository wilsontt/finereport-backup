...
export declare const serializeStructure: (structure: Structure, data: any) => Buffer<ArrayBuffer>;
export declare const serializeValue: (value: Value, structureField: StructureField) => Buffer;
export declare const serializeDate: (date: Date) => Buffer<ArrayBuffer>;
export declare const serializeString: (value: string, structureField: StructureField) => Buffer<ArrayBuffer>;
